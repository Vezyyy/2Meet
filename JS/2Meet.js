...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updatePostCount = () => {
        const visiblePosts = postsContainer.querySelectorAll('.post:not([style*="display: none"])').length;
        document.getElementById('post-count').textContent = visiblePosts;
    };
    ...
    function filterPosts() {
        ...
        updatePostCount(); // Update the post count after filtering
    }
